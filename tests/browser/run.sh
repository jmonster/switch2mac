...
swiftc -swift-version 6 -warnings-as-errors \
 Sources/GameCubed/Runtime/BrowserBridgeConfiguration.swift \
...
swiftc -swift-version 6 -warnings-as-errors Sources/GameCubed/Protocol/Switch2Protocol.swift \
 tests/output-health/Probe.swift Sources/GameCubed/Runtime/OutputHealth.swift \
 Sources/GameCubed/Runtime/BoundedStateMailbox.swift \
 Sources/GameCubed/Runtime/BrowserBridgeConfiguration.swift \
 "$work/State.swift" Sources/GameCubed/Output/WebSocketHub.swift \
